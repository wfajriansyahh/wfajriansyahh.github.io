                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-success">
                            <i class="fa fa-info-circle fa-fw"></i> Pengumuman<hr>
                            <marquee>Bagi yang mempunyai kesulitan dalam merakit atau meminta rekomendasi part2 dari pc, bisa kontak kami melalui email</marquee><br/>
                            <center>admin@rekayasa-perangkat-lunak.net</center>
                        </div>
                    </div>
                    <!-- /.col-lg-4 -->
                </div>
